...
public abstract class Definition implements java.io.Serializable {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.Definition".hashCode()) + name().hashCode()) + access().hashCode()) + modifiers().hashCode()) + java.util.Arrays.deepHashCode(annotations()));
    }
