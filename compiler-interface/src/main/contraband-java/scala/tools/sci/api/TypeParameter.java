...
public final class TypeParameter implements java.io.Serializable {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.TypeParameter".hashCode()) + id().hashCode()) + java.util.Arrays.deepHashCode(annotations())) + java.util.Arrays.deepHashCode(typeParameters())) + variance().hashCode()) + lowerBound().hashCode()) + upperBound().hashCode());
    }
