...
public final class Val extends scala.tools.sci.api.FieldLike {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.Val".hashCode()) + name().hashCode()) + access().hashCode()) + modifiers().hashCode()) + java.util.Arrays.deepHashCode(annotations())) + tpe().hashCode());
    }
