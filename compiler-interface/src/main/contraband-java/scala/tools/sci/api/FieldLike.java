...
public abstract class FieldLike extends scala.tools.sci.api.ClassDefinition {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.FieldLike".hashCode()) + name().hashCode()) + access().hashCode()) + modifiers().hashCode()) + java.util.Arrays.deepHashCode(annotations())) + tpe().hashCode());
    }
