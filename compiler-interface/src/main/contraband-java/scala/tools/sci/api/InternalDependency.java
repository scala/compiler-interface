...
public final class InternalDependency implements java.io.Serializable {
    ...
    public static InternalDependency create(String _sourceClassName, String _targetClassName, scala.tools.sci.api.DependencyContext _context) {
        return new InternalDependency(_sourceClassName, _targetClassName, _context);
    }
    public static InternalDependency of(String _sourceClassName, String _targetClassName, scala.tools.sci.api.DependencyContext _context) {
        return new InternalDependency(_sourceClassName, _targetClassName, _context);
    }
    private String sourceClassName;
    private String targetClassName;
    private scala.tools.sci.api.DependencyContext context;
    protected InternalDependency(String _sourceClassName, String _targetClassName, scala.tools.sci.api.DependencyContext _context) {
        super();
    ...
    public InternalDependency withContext(scala.tools.sci.api.DependencyContext context) {
        return new InternalDependency(sourceClassName, targetClassName, context);
    }
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.InternalDependency".hashCode()) + sourceClassName().hashCode()) + targetClassName().hashCode()) + context().hashCode());
    }
