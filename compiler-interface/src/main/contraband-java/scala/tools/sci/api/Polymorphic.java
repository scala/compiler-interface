...
public final class Polymorphic extends scala.tools.sci.api.Type {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (17 + "scala.tools.sci.api.Polymorphic".hashCode()) + baseType().hashCode()) + java.util.Arrays.deepHashCode(parameters()));
    }
