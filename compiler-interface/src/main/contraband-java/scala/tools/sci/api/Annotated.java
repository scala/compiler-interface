...
public final class Annotated extends scala.tools.sci.api.Type {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (17 + "scala.tools.sci.api.Annotated".hashCode()) + baseType().hashCode()) + java.util.Arrays.deepHashCode(annotations()));
    }
