...
public abstract class ClassDefinition extends scala.tools.sci.api.Definition {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.ClassDefinition".hashCode()) + name().hashCode()) + access().hashCode()) + modifiers().hashCode()) + java.util.Arrays.deepHashCode(annotations()));
    }
