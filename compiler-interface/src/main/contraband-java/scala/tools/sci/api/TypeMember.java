...
public abstract class TypeMember extends scala.tools.sci.api.ParameterizedDefinition {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.TypeMember".hashCode()) + name().hashCode()) + access().hashCode()) + modifiers().hashCode()) + java.util.Arrays.deepHashCode(annotations())) + java.util.Arrays.deepHashCode(typeParameters()));
    }
