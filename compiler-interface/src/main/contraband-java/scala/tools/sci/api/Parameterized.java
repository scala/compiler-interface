...
public final class Parameterized extends scala.tools.sci.api.Type {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (17 + "scala.tools.sci.api.Parameterized".hashCode()) + baseType().hashCode()) + java.util.Arrays.deepHashCode(typeArguments()));
    }
