...
public final class ClassLike extends scala.tools.sci.api.Definition {
    ...
    public static ClassLike of(String _name, Access _access, Modifiers _modifiers, Annotation[] _annotations, DefinitionType _definitionType, scala.tools.sci.api.Lazy<Type> _selfType, scala.tools.sci.api.Lazy<Structure> _structure, String[] _savedAnnotations, Type[] _childrenOfSealedClass, boolean _topLevel, TypeParameter[] _typeParameters) {
        return new ClassLike(_name, _access, _modifiers, _annotations, _definitionType, _selfType, _structure, _savedAnnotations, _childrenOfSealedClass, _topLevel, _typeParameters);
    }
    private DefinitionType definitionType;
    private scala.tools.sci.api.Lazy<Type> selfType;
    private scala.tools.sci.api.Lazy<Structure> structure;
    private String[] savedAnnotations;
    private Type[] childrenOfSealedClass;
    private boolean topLevel;
    private TypeParameter[] typeParameters;
    protected ClassLike(String _name, Access _access, Modifiers _modifiers, Annotation[] _annotations, DefinitionType _definitionType, scala.tools.sci.api.Lazy<Type> _selfType, scala.tools.sci.api.Lazy<Structure> _structure, String[] _savedAnnotations, Type[] _childrenOfSealedClass, boolean _topLevel, TypeParameter[] _typeParameters) {
    ...
    public ClassLike withSelfType(scala.tools.sci.api.Lazy<Type> selfType) {
        return new ClassLike(name(), access(), modifiers(), annotations(), definitionType, selfType, structure, savedAnnotations, childrenOfSealedClass, topLevel, typeParameters);
    }
    public ClassLike withStructure(scala.tools.sci.api.Lazy<Structure> structure) {
        return new ClassLike(name(), access(), modifiers(), annotations(), definitionType, selfType, structure, savedAnnotations, childrenOfSealedClass, topLevel, typeParameters);
    }
