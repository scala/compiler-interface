...
public abstract class ParameterizedDefinition extends scala.tools.sci.api.ClassDefinition {
    ...
    public int hashCode() {
        return 37 * (37 * (37 * (37 * (37 * (37 * (17 + "scala.tools.sci.api.ParameterizedDefinition".hashCode()) + name().hashCode()) + access().hashCode()) + modifiers().hashCode()) + java.util.Arrays.deepHashCode(annotations())) + java.util.Arrays.deepHashCode(typeParameters()));
    }
