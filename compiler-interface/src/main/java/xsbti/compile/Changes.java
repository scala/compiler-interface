...
/**
 * Defines an interface to query for changes of certain items that have an effect on incremental
 * compilation.
 *
 * <p>The common use case for this interface is to detect added, removed, unmodified and changed
 * source files.
 *
