...
public interface ScalaCompiler {
  ...
  /**
   * Recompile the subset of <code>sources</code> impacted by the changes defined in <code>changes
   * </code> and collect the new APIs.
   *
   ...
   * @param reporter The reporter to which errors and warnings should be reported during
   *     compilation.
   ...
   * @param sources All the sources of the project.
   * @param changes The changes that have been detected at the previous step.
   * @param options The arguments to give to the Scala compiler. For more information, run `scalac
   *     -help`.
   ...
   * @param log The logger in which the Scala compiler will log info.
   * @param progressOpt The progress interface in which the Scala compiler will report on the file
   *     being compiled.
   */
  void compile(
      VirtualFile[] sources,
