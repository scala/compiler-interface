 ...
 *
 * <p>The analysis interface conforms the public API of the Analysis files that contain information
 * about the incremental compilation of a project.
 */
public interface CompileAnalysis extends Serializable {
  ...
  /**
   * Returns a read-only source infos interface that allows users to get compiler information on
   * every source file they wish to.
   *
