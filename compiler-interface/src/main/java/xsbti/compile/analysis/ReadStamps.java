...
public interface ReadStamps {
   ...
   *
   * <p>Note that the internal source has to be a source under compilation.
   *
   ...
   *
   * <p>Note that the returned map can be empty if no compilation has happened yet.
   *
   * @return A map of product files to stamps. (e.g. compile analysis is empty).
   */
