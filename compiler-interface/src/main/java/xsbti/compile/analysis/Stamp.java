 ...
 *
 * <p>Stamp properties are available depending on its associated file.
 *
 * <p>A stamp is empty when <code>getHash</code> and <code>getModified</code> return an empty {@link
 * Optional optional}. This value is returned for files that have not been tracked by the
