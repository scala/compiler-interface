 ...
 *
 * <p>The reporter exposes compilation errors coming from either Scala or Java compilers. This
 * includes messages with any level of severity: from error, to warnings and infos.
 */
